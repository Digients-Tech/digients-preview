...
Prospective embodied-AI customers and research engineers evaluating real egocentric video and structured behavior annotations. They use desktop browsers during technical evaluation and customer demonstrations, with mobile support for shared links.
...
Professional, restrained, forward-looking. A precise Silicon Valley AI startup product whose confidence comes from the quality and legibility of real data. English by default with Chinese annotation support.
...
Keyboard-operable controls, visible focus, readable contrast, responsive layouts, reduced-motion support, text alternatives for icon buttons, and understandable loading/error/empty states. Meaning must not depend on color alone.
